...
class NewsClassificationPredictorV1(BasePredictor):
    ...
    def predictor_description(self) -> str:
        return f"ONNX version of facebook/bart-large-mnli for news classification with {len(self.CANDIDATE_LABELS)} predefined categories"
